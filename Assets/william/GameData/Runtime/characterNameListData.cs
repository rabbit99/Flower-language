...
/// 
[System.Serializable]
public class characterNameListData : ScriptableObject 
{
    ...
    public characterNameListDataData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new characterNameListDataData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public characterNameListDataData FindByKey(string key)
    //{
