...
namespace Gamekit2D
{
    ...
    public class PlayerCharacterEditor : Editor
    {
        ...
        readonly GUIContent m_JoystickSettingsContent = new GUIContent("Joystick Settings");
        ...
        void OnEnable ()
        {
            ...
            m_Joystick = serializedObject.FindProperty("variableJoystick");
        }
        ...
        public override void OnInspectorGUI ()
        {
            ...
            m_VariableJoystick = EditorGUILayout.Foldout(m_VariableJoystick, m_JoystickSettingsContent);

            if (m_VariableJoystick)
            {
                EditorGUILayout.PropertyField(m_Joystick, m_JoystickSettingsContent);
            }
