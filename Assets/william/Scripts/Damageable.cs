...
namespace Gamekit2D
{
    public class Damageable : MonoBehaviour, IDataPersister
    {
        ...
        [Serializable]
        public class BeforeDamageEvent : UnityEvent<Damager, Damageable>
        { }
        ...
        public BeforeDamageEvent OnBeforeTakeDamage;
        ...
        public void TakeDamage(Damager damager, bool ignoreInvincible = false)
        {
            if ((m_Invulnerable && !ignoreInvincible) || m_CurrentHealth <= 0)
                return;
            //OnBeforeTakeDamage.Invoke(damager, this);
            if (PlayerCharacter.PlayerInstance.GetHurtResult(damager))
                return;
